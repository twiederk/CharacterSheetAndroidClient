...
public class CreateDatabaseAndGameSystemAsyncTask extends AbstractAsyncTask {
     ...
     * 
     * @param activity
     *            The activity to display the wait animation.
     * @param callbackInterface
     *            Called if the game system is loaded.
     * @param dndDBHelper
     *            The helper to the DnDv35 database.
     * @param pathfinderDBHelper
     *            The helper to the Pathfinder database.
     * @param gameSystemType
     *            The game system to create the game system for.
     */
    public CreateDatabaseAndGameSystemAsyncTask(final Activity activity,
            final AbstractAsyncTask.GameSystemLoadable callbackInterface, final DBHelper dndDBHelper,
            final DBHelper pathfinderDBHelper, final GameSystemType gameSystemType) {
