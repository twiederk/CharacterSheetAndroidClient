...
public enum GameSystemType {
    ...
    DNDV35(1, //
            ...
            createUpdateScriptMap(new int[]{59, 72, 73, 77, 78},
                    new ScriptResource[]{
                            ...
                            new RawScriptResource(R.raw.dndv35_upgrade_78_to_79),
                    }),
    ...
    PATHFINDER(2, //
            ...
            createUpdateScriptMap(
                    ...
                    new ScriptResource[]{
                            ...
                            new RawScriptResource(R.raw.pathfinder_upgrade_78_to_79), //
                    }),
            createUpdateImageMap(new int[]{72, 77},
                    new ImageResources[]{
                            new ImageResources(
    ...
    DND5E(3, //
            ...
            Arrays.asList( //
                    ...
                    new RawScriptResource(R.raw.dnd5e_phb_spell), //
                    new RawScriptResource(R.raw.dnd5e_phb_character) //
            ), //
            createUpdateScriptMap(
                    new int[]{69, 70, 71, 72, 73, 75, 77, 78, 80, 82},
                    new ScriptResource[]{
                            ...
                            new RawScriptResource(R.raw.dnd5e_upgrade_78_to_79), //
                            new RawScriptResource(R.raw.dnd5e_upgrade_80_to_81), //
                            new RawScriptResource(R.raw.dnd5e_upgrade_82_to_83), //
                    }),
            createUpdateImageMap(new int[]{72, 77},
                    new ImageResources[]{
                            new ImageResources(
