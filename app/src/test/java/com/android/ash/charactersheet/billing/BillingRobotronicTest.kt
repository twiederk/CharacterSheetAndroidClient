...
@MediumTest
class BillingRobotronicTest : KoinTest {

    private val messageDisplay: Lazy<MessageDisplay> = inject()
    ...
    fun onBillingSetupFinished_responseCodeNotOk_displayErrorMessage() {
        ...
        verify(messageDisplay.value).display(R.string.billing_connection_error, BillingResponseCode.ERROR)
    }
    ...
    fun startBillingFlow_billingClientIsNull_displayErrorMessage() {
        ...
        // Assert
        argumentCaptor<Int> {
            verify(messageDisplay.value).display(capture())
    ...
    fun onPurchasesUpdated_premiumVersionPurchased_setPremiumVersionAsPurchasedAndAknowledgePurchase() {
        ...
        verifyZeroInteractions(messageDisplay.value)
    }
    ...
    fun onPurchasesUpdated_purchaseIsPending_setPremiumVersionAsPendingAndDoNotAcknowledgePurchaseAndDisplayMessage() {
        ...
        verifyZeroInteractions(billingClient)
        verify(messageDisplay.value).display(R.string.billing_purchase_pending)
    }
    ...
    fun onPurchasesUpdated_someError_displayErrorMessage() {
        ...
        // Assert
        verifyZeroInteractions(billingClient)
        verify(messageDisplay.value).display(R.string.billing_purchasesUpdated_error, BillingResponseCode.ERROR)
    }
    ...
    fun querySkuDetailsList_billingClientNotReady_startConnection() {
        ...
        // Assert
        verify(messageDisplay.value).display(R.string.billing_no_connection_querySkuDetailsList)
    }
    ...
    fun queryPurchases_billingClientIsNotReady_displayErrorMessage() {
        ...
        // Assert
        verify(messageDisplay.value).display(R.string.billing_no_connection_queryPurchases)
    }
    ...
    fun onAcknowledgePurchaseResponse_error_displayErrorMessage() {
        ...
        // Assert
        verify(messageDisplay.value).display(R.string.billing_onAcknowledgePurchaseResponse_error, BillingResponseCode.ERROR)
    }
