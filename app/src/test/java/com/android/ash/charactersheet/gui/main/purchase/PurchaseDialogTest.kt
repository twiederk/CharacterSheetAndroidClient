...
class PurchaseDialogTest : KoinTest {
    ...
    private val billing: Lazy<Billing> = inject()
    ...
    fun show_showPurchaseDialog_showDialogAndLogFirebaseEvent() {
        ...
        verify(firebaseAnalytics.value).logEvent(FBAnalytics.Event.PURCHASE_DIALOG_SHOW, null)
    }
    ...
    fun performPurchase_purchasePremiumVersion_startBillingFlowAndLogFirebaseEvent() {
        ...
        // Assert
        verify(billing.value).startBillingFlow(any())
        verify(firebaseAnalytics.value).logEvent(FBAnalytics.Event.PURCHASE_PERFORM, null)
    }
    ...
    fun cancelPurchase_purchaseCancel_closeDialogAndLogFirebaseEvent() {
        ...
        verify(firebaseAnalytics.value).logEvent(FBAnalytics.Event.PURCHASE_CANCEL, null)
    }
    ...
    fun restorePurchase_PurchaseRestore_queryPurchase() {
        ...
        // Assert
        verify(firebaseAnalytics.value).logEvent(FBAnalytics.Event.PURCHASE_RESTORE, null)
        verify(billing.value).queryPurchases()
        verify(dialog).cancel()
    }
