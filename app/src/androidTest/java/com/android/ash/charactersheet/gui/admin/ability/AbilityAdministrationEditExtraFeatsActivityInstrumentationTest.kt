...
class AbilityAdministrationEditExtraFeatsActivityInstrumentationTest : KoinTest {

    private val gameSystemHolder by inject<GameSystemHolder>()

    private lateinit var scenario: ActivityScenario<AbilityAdministrationEditExtraFeatsActivity>
    ...
    fun onCreate() {
        ...
        val intent = Intent(targetContext, AbilityAdministrationEditExtraFeatsActivity::class.java).putExtra(Constants.INTENT_EXTRA_DATA_OBJECT, 1)
        ...
        // Assert
        onView(isAssignableFrom(Toolbar::class.java)).check(matches(withToolbarTitle(Is.`is`("Edit Extra Feats Ability"))))
        ...
        onView(allOf(withParent(withId(R.id.ability_administration_extrafeats)), withClassName(endsWith("TextView")))).check(matches(withText("1")))
