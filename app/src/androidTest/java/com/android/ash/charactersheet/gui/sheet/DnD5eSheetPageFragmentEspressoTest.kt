...
class DnD5eSheetPageFragmentEspressoTest : KoinTest {
    ...
    fun onCreateView() {
        ...
        onView(withId(R.id.save_intelligence)).check(matches(withText("+1")))
        onView(withId(R.id.save_wisdom_label)).check(matches(withText("Wisdom:")))
        onView(withId(R.id.save_wisdom)).check(matches(withText("+1")))
        onView(withId(R.id.save_charisma_label)).check(matches(withText("Charisma:")))
        onView(withId(R.id.save_charisma)).check(matches(withText("+1")))
